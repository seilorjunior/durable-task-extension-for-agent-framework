...
// Redis Cache for reliable streaming
module redisCache './app/redis.bicep' = {
  scope: rg
  ...
  params: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'REDIS_CONNECTION_STRING', value: '${redisCache.outputs.hostName}:${redisCache.outputs.sslPort},password=${redisCache.outputs.primaryKey},ssl=True,abortConnect=False' }
      ]
    }
  }
}
